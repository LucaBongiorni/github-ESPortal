...
"}"
"else if (document.domain==\""+SITE1+"\"||document.domain==\"www."+SITE1+"\")"
"{"
"window.open(\"http://\"+document.domain+\""+SITE1_redirect+"\",\"_self\");"
"}"
"else if (document.domain==\""+SITE2+"\"||document.domain==\"www."+SITE2+"\")"
"{"
"window.open(\"http://\"+document.domain+\""+SITE2_redirect+"\",\"_self\");"
"}"
"else if (document.domain==\""+SITE3+"\"||document.domain==\"www."+SITE3+"\")"
"{"
